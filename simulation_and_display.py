...
def draw_graphs(test_dir, test_names, average_errors_list, std_dev_errors_list, object_name):
...
def make_graphs_and_videos(test_dir, number_of_objects, object_types, number_of_iterations, available_methods, basic_scene_data, object_rotation_axes,
    ...
    for object_index in np.arange(number_of_objects):
        ...
        if COM_errors_list_array.shape[-1]==0:
            continue
        ...
        print("average_COM_errors",average_COM_errors)
        draw_graphs(test_dir, test_names, average_COM_errors, std_dev_COM_errors, object_types[object_index])
